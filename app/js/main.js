...
(function(){
    ...
    var instagramModule = angular.module('instagramModule',['ngRoute']);
...
instagramModule.controller('UserCtrl',["$scope","$http","Url",function($scope,$http,Url){
...
instagramModule.controller('SearchCtrl',['$scope','$http','Url',function($scope,$http,Url){
    var token = Url.access_token;
